...
- [Bid](../interfaces/.Bid.md)
- [TokenERC721](../interfaces/.TokenERC721.md)
- [WalletAddressProfile](../interfaces/.WalletAddressProfile.md)
...
Ƭ **Item**: `Omit`<`APIItem`, ``"paymentMethodData"`` \| ``"type"`` \| ``"cryptoCurrency"``\> & { `cryptoCurrency`: `CryptoCurrencyRate` ; `paymentMethodData`: [`PaymentMethodData`](.md#paymentmethoddata) ; `type`: [`ItemType`](.md#itemtype)  }
...
Ƭ **ItemStock**: `Omit`<`APIItemStock`, ``"status"`` \| ``"item"``\> & { `item`: [`Item`](.md#item) ; `status`: `ItemStockStatus`  }
...
Ƭ **PaymentMethod**: [`PaymentMethodData`](.md#paymentmethoddata)[``"paymentMethod"``]
...
| `imageURIHTTP` | { `mimeType`: `string` ; `url`: `string`  } | Preview url for imageURI imageURIのブラウザ閲覧用 https://xxxx |
...
| :------ | :------ |
| `address` | `string` |
| `balance` | [`BigNumber`](.md#bignumber) |
| `unit` | [`CurrencyUnit`](.md#currencyunit) |
